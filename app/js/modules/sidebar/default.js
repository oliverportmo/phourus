...
(function() {
  define(["jquery", "underscore", "backbone", "text!html/sidebar/default.html", "js/models/settings", "js/models/session", "js/modules/standard/models/user", "js/collections/history", "js/collections/notifications"], function($, _, Backbone, template, mSettings, mSession, mUser, cHistory, cNotifications) {
    var view;
    ...
    view = Backbone.View.extend({
      ...
      render: function() {
        ...
        if (mSession.auth() === false) {
          return $(this.el).html('You must be logged in');
        } else {
          self = this;
          u = new mUser({
            id: mSession.auth()
