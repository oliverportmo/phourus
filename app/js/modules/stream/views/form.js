...
define(["jquery", "underscore", "backbone", "forms", "text!html/stream/form.html", "text!html/headings/post.html", "text!html/headings/user.html", "js/modules/stream/models/post", "js/models/types", "js/models/session"], function($, _, Backbone, forms, tForm, tPostHeading, tUserHeading, mSingle, mTypes, mSession) {
  var view;
  ...
  view = Backbone.View.extend({
    ...
    initialize: function(options) {
      ...
      return this.model = new mSingle(options);
    },
    events: {
      "click .back": "back",
      "click #create": "create",
