...
define(["jquery", "underscore", "backbone", "text!html/standard/home.html", "js/models/types", "js/views/login", "js/views/register"], function($, _, Backbone, template, mTypes, vLogin, vRegister) {
  var view;
  ...
  view = Backbone.View.extend({
    ...
    render: function() {
      var container, data, html, options;
      ...
      options = {};
      options.type = 'short';
      this.register = new vRegister(options);
