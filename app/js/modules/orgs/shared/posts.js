...
define(["jquery", "underscore", "backbone", "text!html/widgets/posts.html", "js/modules/orgs/collections/posts", "js/models/types", "text!html/items/post.html"], function($, _, Backbone, template, cPosts, mTypes, tPost) {
  var widget;
