...
define(["jquery", "underscore", "backbone", "text!html/orgs/org.html", "text!html/headings/org.html", "js/modules/orgs/models/org"], function($, _, Backbone, template, tHeading, model) {
  var view;
        ...
        error: function(model, response) {
          if (response.status === 404) {
            Backbone.Events.trigger("alert", {
              type: "message",
              message: "Org could not be found",
              response: response,
