...
define(["jquery", "underscore", "backbone", "forms"], function($, _, Backbone, forms) {
  var mTypes;
  ...
  mTypes = Backbone.Model.extend({
    initialize: function() {
      ...
      */
      ...
      var EARTH, MIND, SELF, VOICE, earth, mind, self, voice;
      ...
      return this.set([EARTH, MIND, VOICE, SELF]);
    },
    ...
    schema: function(type) {
      var element, email, handle, password, privacy, required, schema, states, terms, zip;
      ...
      privacy = {
        type: "Select",
        options: ["Public", "Phourus", "Private"]
      };
      switch (type) {
        case "blogs":
          schema.title = "Text";
          ...
          schema.category = {
            type: "Select",
            options: ["Factual", "Opinion", "Idea", "Humor", "Rant"]
          };
        ...
        case "address":
          states = [];
          _.each(this.states, function(val, key, obj) {
            return states.push({
              label: val,
              val: key
            });
